export default {
    ...
    previousitembutton: ({ parent }) => ({
        class: [
            ...
            // Appearance
            'bg-gray-500 text-white w-16 h-16 transition duration-200 ease-in-out rounded-md',
            {
                'opacity-0 group-hover:opacity-50': parent.props.showItemNavigatorsOnHover
            },
